...
public class Main_3F {
     ...
     */
//    public static Chap03.Range getBestRange(int n, int m, int[] cards, Chap03.Range[] ranges) {
//        Chap03.Range answer = ranges[0];
//        long max = Long.MIN_VALUE;
//        int maxIndex = 0;
//
//            for(int j = 0 ; j < ranges.length; j++){
//                for(int i = ranges[j].left ; i <= ranges[j].right; i++){
//                    ranges[j].totalPoint += cards[i];
//                }
//
//                if (ranges[j].totalPoint > max) {
//                    max = ranges[j].totalPoint;
//                    maxIndex = j;
//                }
//            }
...
//    }
    public static Range getBestRange(int n, int m, int[] cards, Range[] ranges) {
        ...
        for(Range range : ranges){
            ...
            if(max < range.totalPoint){
               answer = range;
               max = range.totalPoint;
            }
        }
        return answer;
    }
